...
<body>
    <div class=""email-container"">
            ...
            string manageBookingUrl)
        {
            ...
            var cinemaAddress = Encode(Fallback(request.CinemaAddress, "Cập nhật tại mục Vé của tôi"));
            var paymentMethod = Encode(Fallback(request.PaymentMethod, "Ngân hàng trực tuyến"));
            var transactionId = Encode(Fallback(request.TransactionId, "Đang cập nhật"));
            var bookingCode = Encode(request.BookingCode);
            var bookingId = Encode(request.BookingId);
            var genre = Encode(Fallback(request.MovieGenre, "Đang cập nhật"));
            var duration = request.DurationMinutes > 0 ? $"{request.DurationMinutes} phút" : "Đang cập nhật";
...
<head>
    ...
    <style>
        @media only screen and (max-width: 640px) {
            .mobile-container { border-radius: 0 !important; }
            .mobile-pad { padding: 20px !important; }
            .mobile-heading { font-size: 26px !important; }
            .mobile-text { font-size: 14px !important; }
            .mobile-stack { display: block !important; width: 100% !important; padding-right: 0 !important; }
            .mobile-center { text-align: center !important; }
            .mobile-poster { width: 140px !important; max-width: 140px !important; height: 200px !important; }
...
<body style="margin:0;padding:0;background-color:#f4f1ea;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;color:#1f2937;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#f4f1ea;margin:0;padding:24px 0;">
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" class="mobile-container" style="max-width:680px;background-color:#ffffff;border-radius:28px;overflow:hidden;box-shadow:0 16px 48px rgba(15,23,42,0.10);">
                    <tr>
                        <td style="padding:0;background:linear-gradient(135deg,#111827 0%,#7c2d12 55%,#fb923c 100%);">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="mobile-pad" style="padding:36px 36px 28px 36px;">
                                        ...
                                        <h1 class="mobile-heading" style="margin:0 0 12px 0;font-size:34px;line-height:1.15;color:#ffffff;font-weight:800;">Vé xem phim của bạn đã sẵn sàng</h1>
                                        <p class="mobile-text" style="margin:0;max-width:470px;font-size:16px;line-height:1.7;color:#ffedd5;">
                                            Xin chào {{customerName}}, chúng tôi đã ghi nhận thành công đơn vé của bạn. Bạn có thể đưa email này khi đến rạp hoặc mở mục Vé của tôi để xem lại thông tin bất cứ lúc nào.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:rgba(255,255,255,0.12);border:1px solid rgba(255,255,255,0.16);border-radius:22px;">
                                            <tr>
                                                <td style="padding:22px 24px;">
                                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td style="padding-bottom:8px;font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:#fdba74;font-weight:700;">Mã đơn hàng</td>
                                                            <td align="right" style="padding-bottom:8px;font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:#fdba74;font-weight:700;">Tổng thanh toán</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="padding-top:14px;font-size:13px;color:#ffedd5;line-height:1.6;">
                                                                {{ticketCount}} vé | Ghế {{seatSummary}} | Phương thức thanh toán: {{paymentMethod}}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                    ...
                    <tr>
                        <td class="mobile-pad" style="padding:32px 36px 12px 36px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:separate;border-spacing:0;">
                                <tr>
                                    <td valign="top" class="mobile-stack mobile-center" style="padding:0 20px 20px 0;">
                                        {{posterBlock}}
                                    </td>
                                    <td valign="top" class="mobile-stack" style="padding:0 0 20px 0;">
                    ...
                    <tr>
                        <td class="mobile-pad" style="padding:0 36px 8px 36px;">
                                    ...
                                    <td style="padding:0;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr style="background-color:#111827;">
                                                <td style="padding:14px 18px;font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:#e5e7eb;font-weight:700;">Ghế</td>
                                                <td style="padding:14px 18px;font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:#e5e7eb;font-weight:700;">Loại</td>
                                                <td align="right" style="padding:14px 18px;font-size:12px;letter-spacing:0.08em;text-transform:uppercase;color:#e5e7eb;font-weight:700;">Giá</td>
                                            </tr>
                                            {{ticketRows}}
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td class="mobile-pad" style="padding:24px 36px 0 36px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:20px;">
                                <tr>
                                    <td style="padding:22px 24px;">
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="padding:0 0 12px 0;font-size:14px;color:#475569;font-weight:600;">Mã booking</td>
                                                <td align="right" style="padding:0 0 12px 0;font-size:15px;color:#0f172a;font-weight:700;">{{bookingId}}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:0 0 12px 0;font-size:14px;color:#475569;font-weight:600;">Mã giao dịch</td>
                                                <td align="right" style="padding:0 0 12px 0;font-size:15px;color:#0f172a;font-weight:700;">{{transactionId}}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:0;font-size:14px;color:#475569;font-weight:600;">Tổng tiền</td>
                    ...
                    <tr>
                        <td class="mobile-pad" style="padding:28px 36px 0 36px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:linear-gradient(135deg,#111827 0%,#1f2937 100%);border-radius:22px;">
                                <tr>
                                    <td style="padding:26px 28px;">
                                        ...
                                        <a href="{{manageBookingUrl}}" class="mobile-button" style="display:inline-block;padding:14px 24px;border-radius:999px;background-color:#f97316;color:#fff7ed;text-decoration:none;font-size:14px;font-weight:800;letter-spacing:0.02em;">
                                            Xem vé của tôi
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mobile-pad" style="padding:24px 36px 36px 36px;">
...
"""
        ...
        private static string BuildPosterBlock(string? posterUrl, string movieTitle)
        {
            if (string.IsNullOrWhiteSpace(posterUrl))
            {
                return
                    """
<div class="mobile-poster" style="width:180px;height:256px;border-radius:24px;background:linear-gradient(180deg,#111827 0%,#374151 100%);padding:22px;box-sizing:border-box;">
    <div style="font-size:12px;letter-spacing:0.18em;text-transform:uppercase;color:#fbbf24;font-weight:700;margin-bottom:18px;">Đang chiếu</div>
    <div style="font-size:28px;line-height:1.25;color:#ffffff;font-weight:800;">Đêm chiếu phim</div>
...
""";
            ...
            return $$"""
<img class="mobile-poster" src="{{Encode(posterUrl)}}" alt="{{Encode(movieTitle)}}" width="180" style="display:block;width:180px;max-width:180px;height:256px;object-fit:cover;border-radius:24px;border:1px solid #fed7aa;margin:0 auto;" />
""";
        }
